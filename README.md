...
- **誰に解説してもらうかを選べる** — 「猫の語り手の口調で」「講談調で」と書いておけば、
  下書きがその調子になる。**作品ごとに置ける**ので、小説と社内資料で切り替え直さずに済む
  （→ [文体（口調）のレシピ](docs/voices.md)、実物は
  [samples/坊っちゃん](samples/坊っちゃん/)）
...
| [docs/voices.md](docs/voices.md) | 文体（口調）のレシピ。青空文庫の作品別に、書くとよい指示 |
